...
<div x-data="{ isOpen: false }" class="fixed bottom-0 right-0 p-4">
    ...
    <div x-show="isOpen" class="absolute bottom-0 right-0 p-4">
        <iframe style="width: 100%; height: 340px;"
            src="https://app.fastbots.ai/embed/clzmnuykj0001r9bg2oiq2fz1"></iframe>
    </div>
</div>
