...
<div class="flex flex-wrap gap-4 px-4 pb-4 pt-6 shadow-sm lg:hidden">
                        ...
                        <x-slot:content>
                            ...
                            <div
                                ...
                                <div class="flex flex-col justify-between gap-2.5 max-md:gap-0">
                                    <p class="font-mediums text-2xl max-md:text-xl">Hello! {{
                                        auth()->user()?->first_name }}</p>

                                    <p class="text-zinc-500 no-underline max-md:text-sm">{{ auth()->user()?->email }}
                                    </p>
                                </div>
                                @endauth
                            </div>
    ...
    <form action="{{ route('shop.search.index') }}" class="flex w-full items-center">
        ...
        <div class="relative w-full">
            <div
                class="icon-search pointer-events-none absolute top-3 flex items-center text-2xl max-md:text-xl max-sm:top-2 ltr:left-3 rtl:right-3">
            </div>
